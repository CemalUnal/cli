...
You can control which resources KubeDB should keep or delete when you delete Postgres crd through `spec.terminationPolicy`. KubeDB provides following three termination policies:
...
| 8. Delete WAL archive data from bucket | &#10007; | &#10007; | &#10003; |
